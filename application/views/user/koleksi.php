                            ...
                            <div class="text-center">
                                ...
                                <div class="mt-3">
                                    <b style="
                                        ...
                                        width: 140px;
                                        border-radius: 10px;
                                        padding: 6px 15px 6px 15px;"><?php echo 'Rp ' .number_format($item->harga) ?> / hari</b>
                                </div>
                            </div>
                        </div>
                        <!-- Product actions-->
    ...
    <div class="modal fade" id="modalLogin" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
          ...
          <div class="modal-header bg-success text-light">
            ...
            <div class="modal-footer">
              ...
              <button type="button" class="btn btn-success" href="<?php echo site_url('user/home')?>">Login</button>
            </div>
          </div>
      </div>
    </div>    
...
<script type="text/javascript">
    $(function()
    {
        ...
        $('.swalDefaultSuccess').click(function() {
            Toast.fire({
                icon: 'success',
                title: 'Produk berhasil masuk ke keranjang'
            })
        });
    });
</script>
